    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VDialog, mergeProps({
        ...
        default: withCtx(({ isActive }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VCard, { title: "编辑用户信息" }, {
                          ...
                          "append-inner": withCtx((_3, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(VBtn, {
                                ...
                                title: "随机昵称",
                                variant: "text",
                                onClick: ($event) => userName.value = "哇多么好的机会啊" + Math.random().toString(36).substring(2, 8)
                              }, {
            ...
            return [
              createVNode(VCard, { title: "编辑用户信息" }, {
                default: withCtx(() => [
                  createVNode(VCardText, null, {
                    default: withCtx(() => [
                      createVNode(VTextField, {
