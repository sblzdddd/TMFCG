import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, toRef, inject as inject$1, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, computed, watchEffect, toRefs, capitalize, Fragment, watch, ref, unref, provide, h, warn, defineComponent as defineComponent$1, createVNode, mergeProps, onScopeDispose, Suspense, nextTick, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { k as createHooks, l as getContext, i as createError$1, m as toRouteMatcher, n as createRouter, o as defu, q as hasProtocol, v as joinURL, w as withQuery, x as sanitizeStatusCode, y as isScriptProtocol, z as executeAsync, A as defuFn, B as klona } from '../_/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    name: "cards_wiki",
    path: "/cards_wiki",
    component: () => import('./cards_wiki.vue.mjs')
  },
  {
    name: "make_cards",
    path: "/make_cards",
    component: () => import('./make_cards.vue.mjs')
  },
  {
    name: "room-code",
    path: "/room/:code()",
    meta: __nuxt_page_meta || {},
    component: () => import('./_code_.vue.mjs')
  }
];
...
function createGoTo(options, locale) {
  return {
    rtl: locale.isRtl,
    options: mergeDeep(genDefaults$3(), options)
  };
}
...
/* empty css                                                        */
const vuetify_A4vj6Blz0rziNPFx8IAs4cm4oy_tLrlU0fESn0FMtnw = defineNuxtPlugin((app) => {
...
const layouts = {
  ...
  "in-game": defineAsyncComponent(() => import('./in-game.vue.mjs').then((m) => m.default || m))
};
...
export { useIcon as $, isPrimitive as A, useRoute as B, getCurrentInstance as C, consoleError as D, EventProp as E, deprecate as F, clamp as G, useToggleScope as H, IconValue as I, useTheme as J, pickWithRest as K, destructComputed as L, defer as M, templateRef as N, callEvent as O, isClickInsideElement as P, getNextElement as Q, focusableChildren as R, isCssColor as S, isParsableColor as T, parseColor as U, getForeground as V, isObject as W, keyCodes as X, getCurrentInstanceName as Y, includes as Z, _export_sfc as _, useNuxtApp as a, flattenFragments as a0, consoleWarn as a1, findChildrenWithProvide as a2, hasEvent as a3, useAppConfig as a4, asyncDataDefaults as a5, createError as a6, tryUseNuxtApp as a7, PageRouteSymbol as a8, LayoutMetaSymbol as a9, generateRouteKey$1 as aa, server as ab, useRuntimeConfig as b, nuxtLinkDefaults as c, provideTheme as d, provideDefaults as e, pick as f, genericComponent as g, useRtl as h, useLocale as i, convertToUnit as j, keys as k, deepEqual as l, makeThemeProps as m, navigateTo as n, useProxiedModel as o, propsFactory as p, getUid as q, resolveRouteObject as r, filterInputAttrs as s, matchesSelector as t, useRouter as u, omit as v, wrapInArray as w, defineComponent as x, focusChild as y, getPropertyFromItem as z };
